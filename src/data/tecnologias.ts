...
export const tecnologiasData: Tecnologia[] = [
    ...
    { id: 12, nombre: 'PHP', icono: 'fab fa-php' },
    { id: 13, nombre: 'MySQL', icono: 'fas fa-database' },
    { id: 14, nombre: 'Bootstrap', icono: 'fab fa-bootstrap' },
    { id: 15, nombre: 'jQuery', icono: 'fas fa-code' },
